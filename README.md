...
## Case Study
  - ### Description
    ...
    - 표 2: 정의한 네 가지의 평가 기준에 대한 평가 점수
      ...
      - FireReport-MAS (Image+Log)가 모든 평가 항목에서 가장 높은 점수를 기록함. 맥락을 이해하는 '상황 판단(A)'과 보고서의 전반적인 '품질(Q)' 항목에서 높은 성능을 보인 것은 자체 평가 및 피드백 기반 순환을 반복적으로 수행하는 MAS 구조가 보고서의 완성도를 높이는 데 기여함.
